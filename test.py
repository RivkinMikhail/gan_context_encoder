...
from model_modified import _netG
...
if __name__ ==  '__main__':
    ...
    a = torch.FloatTensor(opt.batchSize,opt.nc,opt.imageSize,opt.imageSize)
    a = a.zero_()
    ...
    with torch.no_grad():
        ...
        real_center_cpu = real_cpu[:,:,int(opt.imageSize/2-opt.cropSize/2):int(opt.imageSize/2+opt.cropSize/2),
                                       int(opt.imageSize/2-opt.cropSize/2):int(opt.imageSize/2+opt.cropSize/2)]
        real_center.resize_(real_center_cpu.size()).copy_(real_center_cpu)
        input_cropped=transforms.functional.erase(input_cropped, int(opt.imageSize/2-opt.cropSize/2),int(opt.imageSize/2-opt.cropSize/2),
                                       int(opt.cropSize),int(opt.cropSize),a[:,:,int(opt.imageSize/2-opt.cropSize/2):int(opt.imageSize/2+opt.cropSize/2),
                               int(opt.imageSize/2-opt.cropSize/2):int(opt.imageSize/2+opt.cropSize/2)])    
